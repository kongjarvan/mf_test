...
// 날씨 규칙
//
// 매 낮 생존 진영 인원 기준으로 자동 결정된다.
// 안개 → 눈 → 비 순으로 첫 번째로 맞는 조건을 적용하고,
// 모두 아니면 맑은 날이다.
//
// 날씨       유리 진영    조건
// ──────────────────────────────────────────────
// 맑은 날    시민        위 세 조건에 해당하지 않을 때
// 눈이 옴    중립        생존 중립 ≥ 1  AND  마피아×2 ≥ (중립+시민+좀비)
// 비가 옴    마피아      생존 중립 = 0  AND  마피아×2 ≥ (시민+좀비)
// 안개       좀비 세력   (마피아+중립) ≤ 2  AND  좀비×2 ≥ (마피아+중립+시민)
//
// 생존 인원은 직업의 진영 기준으로 센다.
// ─────────────────────────────────────────────
